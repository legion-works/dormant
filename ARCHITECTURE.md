...
5. For `scope = "shared"`, the ownership gate receives a local VCP `0x60` observation before the executor acts. mDNS and paired identities support instance pairing only; panel ownership, presence, and panel state are never broadcast.
